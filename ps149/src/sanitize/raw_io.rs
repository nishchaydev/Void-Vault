...
use windows::Win32::Storage::FileSystem::{
    CreateFileW, FlushFileBuffers, SetFilePointerEx, FILE_BEGIN, FILE_FLAGS_AND_ATTRIBUTES,
    FILE_FLAG_NO_BUFFERING, FILE_SHARE_READ, FILE_SHARE_WRITE, OPEN_EXISTING,
};
...
pub fn open_disk_write(disk_index: u32, _device_type: &DeviceType) -> Result<DiskHandle> {
    info!("I/O mode: High-throughput buffered write with final FlushFileBuffers()");
    let flags = FILE_FLAGS_AND_ATTRIBUTES(0);
