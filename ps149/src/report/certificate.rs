    ...
    pub fn build(
        ...
        Self {
            ...
            verification: VerificationInfo {
                result: if verify_result.passed {
                    "PASS".into()
                } else {
                    "FAIL".into()
                },
...
impl FileErasureCertificate {
    ...
    pub fn to_text_summary(&self) -> String {
        ...
        text.push_str(&format!(
            ...
            self.total_bytes_erased,
            self.total_bytes_erased as f64 / 1_048_576.0
        ));
        ...
        text.push_str(&format!(
            "NTFS Alternate Data Streams Purged: {}\n",
        ...
        text.push_str(&format!(
            "MFT Filename Obfuscated (5-Pass Rename): {}\n",
            if self.filename_obfuscated {
                "YES"
            } else {
                "NO"
            }
