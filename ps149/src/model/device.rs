...
/// S.M.A.R.T. firmware health telemetry and G-List defect status.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SmartHealth {
    /// SMART attribute 0x05: Reallocated Sectors Count (G-List).
    pub reallocated_sectors: u32,
    /// SMART attribute 0xC5: Current Pending Sector Count.
    pub pending_sectors: u32,
    /// G-List status description.
    pub g_list_status: String,
    /// Whether cryptographic Purge or physical destruction is mandated per NIST SP 800-88 §4.1.
    pub purge_mandated: bool,
    /// Estimated flash endurance / health percentage.
...
pub struct PhysicalDisk {
    ...
    /// S.M.A.R.T. firmware health inspection and G-List status.
