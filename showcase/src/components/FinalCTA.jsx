    ...
    <section className="py-24 md:py-36 border-t border-white/5 bg-[#05070B] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mb-12">
          <a
            href="#demo"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 shadow-xl shadow-cyan-950/60 border border-cyan-400/40 transition-all hover:scale-[1.02]"
          >
