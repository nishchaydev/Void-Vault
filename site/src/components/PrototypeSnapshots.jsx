...
export default function PrototypeSnapshots({ onOpenLightbox }) {
  ...
  return (
    <section id="prototype" className="py-20 md:py-28 border-t border-white/[0.04] bg-[#050505] relative overflow-hidden">
      {/* Ambient center glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[320px] bg-orange-500/5 blur-[130px] pointer-events-none rounded-full" />
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-mono font-medium whitespace-nowrap transition-all duration-200 cursor-pointer ${
                  isSelected
                    ? 'bg-orange-500/20 text-orange-300 border border-orange-500/50 shadow-md shadow-orange-500/10'
        ...
        <div className="group relative rounded-2xl border border-white/[0.08] bg-[#070A10] overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-white/[0.06] bg-white/[0.02] relative z-10">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-mono text-orange-300 hover:text-orange-200 bg-orange-950/40 hover:bg-orange-900/40 border border-orange-800/60 rounded-full transition-colors cursor-pointer"
            >
          ...
          <div className="p-4 sm:p-6 lg:p-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between">
                <div>
                  <div className="inline-block px-2.5 py-0.5 rounded text-[10px] font-mono font-semibold bg-orange-950 text-orange-300 border border-orange-800/60 mb-3">
                    MODULE DEEP DIVE
                  </div>
                ...
                <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.06] text-[11px] font-mono text-neutral-400">
                  ...
                  <span className="text-orange-300/90 break-all">{currentSnapshot.technicalMetadata}</span>
                </div>
              </div>
