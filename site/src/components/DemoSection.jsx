  ...
  return (
    <section id="demo" className="py-16 px-4 max-w-5xl mx-auto">
      ...
      <div className="relative aspect-video rounded-xl bg-neutral-900 border border-white/10 overflow-hidden group flex items-center justify-center cursor-pointer">
        ...
        <div className="w-20 h-20 rounded-full bg-orange-500/20 border border-orange-500/50 flex items-center justify-center group-hover:bg-orange-500/30 transition-all group-hover:scale-110 z-10 backdrop-blur-sm shadow-[0_0_30px_rgba(255, 86, 0,0.3)]">
      ...
      <div className="mt-4 flex justify-between items-center text-sm">
        ...
        <a href="#" className="text-orange-500 hover:underline">Transcript →</a>
      </div>
    </section>
  );
}
