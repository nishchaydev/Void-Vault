...
export default function FinalCTA() {
  return (
    <section className="py-24 md:py-36 border-t border-white/5 bg-[#05070B] relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-orange-600/10 blur-[140px] pointer-events-none rounded-full" />

      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        
        {/* Five Core Pillars Marquee / Banner */}
        <div className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-4 px-4 py-2 rounded-full bg-slate-900/90 border border-slate-700/80 mb-8 text-[11px] font-mono tracking-widest text-orange-300 uppercase shadow-inner">
          <span>FORENSICS</span>
        ...
        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-tight max-w-4xl mx-auto mb-6">
          ...
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-orange-300 to-orange-300 mt-2">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mb-12">
          <a
            href="#demo"
            className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-500 shadow-xl shadow-orange-950/60 border border-orange-500/40 transition-all hover:scale-[1.02]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 px-5 py-3.5 rounded-xl text-sm font-medium text-orange-300 hover:text-orange-200 bg-orange-950/40 border border-orange-800/60 hover:border-orange-600 transition-colors"
          >
