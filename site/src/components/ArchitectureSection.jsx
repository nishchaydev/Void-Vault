                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <span className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded ${isSelected ? 'bg-cyan-900 text-cyan-200' : 'bg-slate-800 text-slate-400'}`}>
                          {layer.step}
                        </span>
            ...
            <div className="p-6 rounded-2xl bg-[#0C121E] border border-slate-800 shadow-xl">
              ...
              <div className="flex flex-wrap gap-2">
                {architectureConfig.layers[selectedLayer].tags.map((tag, tIdx) => (
                  <span
                    key={tIdx}
                    className="px-2.5 py-1 rounded-md bg-slate-900 border border-slate-700/80 text-xs font-mono text-cyan-200"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-950/60 hover:bg-cyan-900/60 text-xs font-mono text-cyan-300 border border-cyan-700/60 transition-colors"
                  >
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-[#090E17] border border-slate-800">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {architectureConfig.techStack.map((tech) => (
              <div
                key={tech.name}
                className="p-4 rounded-xl bg-slate-900/50 border border-slate-800/80 hover:border-cyan-500/40 transition-colors"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[10px] font-mono font-semibold text-cyan-300 px-2 py-0.5 rounded bg-cyan-950/70 border border-cyan-800/60">
                    {tech.badge}
                  </span>
                </div>
